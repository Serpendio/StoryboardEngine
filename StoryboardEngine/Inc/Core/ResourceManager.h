...
namespace StoryboardEngine
{
	...
	public:
		...
		static size_t GetTextureID(const std::string&);
		// Gets a texture name for the resource with the given id. Should be cached during runtime.
		static const std::string& GetTextureName(size_t);
		...
		static size_t GetModelID(const std::string&);
		// Gets a model name for the resource with the given id. Should be cached during runtime.
		static const std::string& GetModelName(size_t);
	...
	protected:
		...
		static size_t LoadTexture(const std::string&, const std::string&, size_t);
		// Loads a model from file and assigns it the given model name and given id. Returns the resource ID of the loaded model.
		static size_t LoadModel(const std::string&, const std::string&, size_t);
		...
		static size_t LoadModel(const std::string&, ModelData*, size_t);
